...
plt.ylabel('$B_R$ (nT)')
plt.title('Parker Solar Probe Magnetic Field (RTN) - Full Cadence Dec 24, 2024')
plt.grid(True)
...
plt.tight_layout()
output_path = r"c:\Users\Jeyaprakash S\Documents\GitHub\parker_solar\switchbacks_plot_dec24.png"
