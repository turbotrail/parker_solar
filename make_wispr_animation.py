...
if __name__ == "__main__":
    # Pointing this directly to the original L3 data folder
    data_directory = "wispr_20241224_data"
    ...
    create_animation(
        ...
        output_filename="wispr_l3_inner_animation.mp4",
        camera_name="Inner"
    )
    ...
    create_animation(
        ...
        output_filename="wispr_l3_outer_animation.mp4",
        camera_name="Outer"
    )
    
    print("\nAll done! Both Inner and Outer L3 animations have been generated.")
